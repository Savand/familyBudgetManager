...
public class BudgetRepositoryImpl implements BudgetRepository {
  ...
  private static final String SELECT_ALL_FROM_BUDGETS = "SELECT id, budget_name as name, description, budget_per_day, initial_budget_amount as budgetAmount FROM budgets ";
  ...
  public BudgetRepositoryImpl(DataSource dataSource) {
      this.insertBudget = new SimpleJdbcInsert(dataSource)
  ...
  public Budget save(Budget budget) {
    ...
    if(budget.isNew()){
      ...
      namedParameterJdbcTemplate.update(
          ...
          + "user_creator_id= :user_creator_id, budget_per_day= :budget_per_day WHERE id=:id", map);
    }
  ...
  public List<Integer> getIdsByUserId(Integer userId) {
    return jdbcTemplate.queryForList("SELECT budget_id FROM users_budgets WHERE user_id=? order by budget_id", Integer.class, userId);
  }
  ...
  public Budget get(int id) {
    ...
    Integer userId = jdbcTemplate.queryForObject("SELECT user_creator_id from budgets where id =" + id, Integer.class);
