...
public interface PreparedBudgetTestData {
  ...
  public static final Budget USER_1_2_BUDGET = new Budget(100004, "users budget", 400, null,
      "budget control of users family money");

  public static final Integer USER_1_2_BUDGET__ID = USER_1_2_BUDGET.getId();

  public static final Budget TEST_BUDGET = new Budget("new budget", 600, 50000, USER1, "new budget just for testing");
